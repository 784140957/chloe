...
if __name__ == '__main__':
    # --config = config / ade20k / ade20k_pspnet50.yaml - -image = figure / demo / ADE_val_00001515.jpg
    # TEST.scales
    # '[1.0]'
    ...
    # model.eval(), args.image, args.classes, mean, std, args.base_size, args.test_h, args.test_w, args.scales, colors
    ...
    image_name = '喵喵测试'
    gray_path = image_name + '_gray.png'
    ...
    plt.axis('off')
    plt.savefig('喵喵测试.jpg', dpi=150, bbox_inches='tight')